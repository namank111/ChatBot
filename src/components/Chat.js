        ...
        <div class="flex">
            ...
            <div class="md:w-5/12 lg:inline md:inline hidden h-screen border-r-2 border-r-gray-700">
                ...
                <div className='flex flex-col justify-center mx-5'>
                    ...
                    <br />
                    <button type="button" className='text-white-900 hover:text-gray border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800'>How to make Projects?</button>
            ...
            <div class="w-full bg-transparent h-screen flex flex-col justify-start items-start">
                ...
                <div className="chatFooter mb-16 p-2 mx-2 w-11/12 bg-transparent rounded flex flex-col justify-center items-center mt-auto">
                    <div className="flex flex-row gap-4 w-11/12 bg-transparent">
                        ...
                        <input
                            className='bg-gray-100 border border-gray-300 outline-none bg-transparent text-white-900 text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-white dark:text-white '
